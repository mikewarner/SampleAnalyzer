...
SpiWithCsSimulationDataGenerator::SpiWithCsSimulationDataGenerator()
{
}
...
void SpiWithCsSimulationDataGenerator::Initialize( U32 simulation_sample_rate, SpiWithCsAnalyzerSettings* settings )
{
...
U32 SpiWithCsSimulationDataGenerator::GenerateSimulationData( U64 largest_sample_requested, U32 sample_rate, SimulationChannelDescriptor** simulation_channels )
{
...
void SpiWithCsSimulationDataGenerator::CreateSpiTransaction()
{
	if( mEnable != NULL )
		mEnable->Transition();
...
void SpiWithCsSimulationDataGenerator::OutputWord_CPHA0( U64 mosi_data, U64 miso_data )
{
...
void SpiWithCsSimulationDataGenerator::OutputWord_CPHA1( U64 mosi_data, U64 miso_data )
{
	BitExtractor mosi_bits( mosi_data, mSettings->mShiftOrder, mSettings->mBitsPerTransfer );
	BitExtractor miso_bits( miso_data, mSettings->mShiftOrder, mSettings->mBitsPerTransfer );
